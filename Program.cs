...
while (continua)
{
    ...
    Console.WriteLine("[1] Aggiungi un documento");
    Console.WriteLine("[2] modifica disponibilità di un documento");
    Console.WriteLine("[3] cancella un documento");
    Console.WriteLine("[4] ricarca un documento");
    Console.WriteLine("[esci] termina programma");
